...
//        return inflater.inflate(R.layout.fragment_compose_u_i, container, false)
        return inflater.inflate(R.layout.fragment_compose_u_i, container, false).apply {
            findViewById<ComposeView>(R.id.composeUIFragment_composeView).setContent {
